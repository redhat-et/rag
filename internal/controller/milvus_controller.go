...
//+kubebuilder:rbac:groups=rag.opendatahub.io,resources=milvuses,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=rag.opendatahub.io,resources=milvuses/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=rag.opendatahub.io,resources=milvuses/finalizers,verbs=update
